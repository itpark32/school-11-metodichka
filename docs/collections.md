...
!!! abstract "Фокус"
    - **Нужно знать:** создание списка, индекс, `len`, `append`, изменение и перебор.
    - **Часто в работе:** поиск, минимум, максимум, сумма и сортировка.
    - **Достаточно узнавать:** устройство учебной пузырьковой сортировки.
