...
!!! abstract "Фокус"
    - **Нужно знать:** поиск по ID, тексту и диапазону, сортировка по полю.
    - **Часто в работе:** нормализация строк, `key` и `reverse`.
    - **Достаточно узнавать:** ручная сортировка объектов соседними перестановками.
